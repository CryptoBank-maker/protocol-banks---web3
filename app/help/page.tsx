        ...
        <div className="space-y-16">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 rounded-xl bg-muted border border-border text-purple-600 dark:text-purple-400">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 rounded-xl bg-muted border border-border text-blue-600 dark:text-blue-400">
                ...
                <table className="w-full text-left text-sm text-muted-foreground">
                  ...
                  <tbody className="divide-y divide-border">
                    ...
                    <tr className="hover:bg-muted/30 bg-blue-500/5">
                      <td className="p-4 font-medium text-blue-700 dark:text-blue-200">x402 Protocol (ERC-3009)</td>
                      <td className="p-4">Ethereum Mainnet</td>
                      <td className="p-4 text-green-600 dark:text-green-400 font-bold">$0.00 (Gasless for User)</td>
                      <td className="p-4">Instant Signature</td>
                    </tr>
                    <tr className="hover:bg-muted/30 bg-purple-500/5">
                      <td className="p-4 font-medium text-purple-700 dark:text-purple-200">CCTP Cross-Chain</td>
                      <td className="p-4">Eth ↔ Base/Op/Arb</td>
                      <td className="p-4 text-green-600 dark:text-green-400">~ $0.50 (Gas only)</td>
                    ...
                    <tr className="hover:bg-muted/30">
                      ...
                      <td className="p-4 text-green-600 dark:text-green-400">&lt; $0.001</td>
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 rounded-xl bg-muted border border-border text-cyan-600 dark:text-cyan-400">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 rounded-xl bg-muted border border-border text-green-600 dark:text-green-400">
            ...
            <div className="mt-8 border border-border rounded-xl overflow-hidden">
              ...
              <div className="divide-y divide-border">
                <div className="p-4 flex gap-4">
                  <div className="w-28 shrink-0 text-sm font-medium text-emerald-600 dark:text-emerald-400">Pre-Transfer</div>
                ...
                <div className="p-4 flex gap-4">
                  <div className="w-28 shrink-0 text-sm font-medium text-blue-600 dark:text-blue-400">During Transfer</div>
                  <div className="text-muted-foreground text-sm">
                ...
                <div className="p-4 flex gap-4">
                  <div className="w-28 shrink-0 text-sm font-medium text-purple-600 dark:text-purple-400">Post-Transfer</div>
                  <div className="text-muted-foreground text-sm">
                ...
                <div className="p-4 flex gap-4">
                  <div className="w-28 shrink-0 text-sm font-medium text-orange-600 dark:text-orange-400">Long-Term Storage</div>
                  <div className="text-muted-foreground text-sm">
            ...
            <div className="mt-6 bg-red-500/10 border border-red-500/30 rounded-xl p-5">
              ...
              <div className="grid md:grid-cols-3 gap-4 text-sm">
                <div>
                  <p className="text-red-700 dark:text-red-300 font-medium mb-1">Malicious Text / Garbage Data</p>
                  <p className="text-muted-foreground">
                    Automatically filters invisible characters, zero-width characters, control characters.
                  </p>
                </div>
                <div>
                  <p className="text-red-700 dark:text-red-300 font-medium mb-1">Malicious Contract Addresses</p>
                  <p className="text-muted-foreground">Checksum validation + optional blacklist checking.</p>
                </div>
                <div>
                  <p className="text-red-700 dark:text-red-300 font-medium mb-1">Injection Attacks</p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              ...
              <div className="bg-muted/50 p-6 rounded-xl border border-border md:col-span-2">
                ...
                <div className="flex items-center gap-2 text-xs text-green-600 dark:text-green-400 bg-green-500/10 px-3 py-2 rounded border border-green-500/30 w-fit">
            ...
            <div className="mt-8 bg-amber-500/10 border border-amber-500/30 rounded-xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-amber-700 dark:text-amber-200 mb-2">Important: User Responsibility Disclaimer</h3>
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-4 mb-4">
              <div className="p-3 rounded-xl bg-muted border border-border text-red-600 dark:text-red-400">
            ...
            <div className="mt-8 border border-border rounded-xl overflow-hidden">
              <div className="bg-muted/50 p-4 border-b border-border flex items-center gap-2">
                ...
                <h3 className="font-bold text-foreground">Pre-Transaction Security Check</h3>
              </div>
              <div className="p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-muted p-4 rounded-lg">
                    <h4 className="text-foreground font-medium text-sm mb-2">Risk Assessment</h4>
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-1 text-xs rounded bg-green-500/20 text-green-600 dark:text-green-400 border border-green-500/30">
                        SAFE
                      </span>
                      <span className="px-2 py-1 text-xs rounded bg-blue-500/20 text-blue-600 dark:text-blue-400 border border-blue-500/30">
                        LOW
                      </span>
                      <span className="px-2 py-1 text-xs rounded bg-yellow-500/20 text-yellow-600 dark:text-yellow-400 border border-yellow-500/30">
                        MEDIUM
                      </span>
                      <span className="px-2 py-1 text-xs rounded bg-orange-500/20 text-orange-600 dark:text-orange-400 border border-orange-500/30">
                        HIGH
                      </span>
                      <span className="px-2 py-1 text-xs rounded bg-red-500/20 text-red-600 dark:text-red-400 border border-red-500/30">
                        CRITICAL
                      </span>
                    </div>
                  </div>
                  <div className="bg-muted p-4 rounded-lg">
                    <h4 className="text-foreground font-medium text-sm mb-2">Security Checks</h4>
                ...
                <p className="text-muted-foreground/70 text-xs mt-4">
                  <strong className="text-amber-600 dark:text-amber-400">Note:</strong> Transactions with CRITICAL risk level will be
            ...
            <div className="mt-6 bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-5">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-bold text-foreground">Transaction Simulation</h3>
              </div>
              <p className="text-muted-foreground text-sm">
                For complex transactions, Protocol Bank can simulate the outcome before submission using
                <code className="mx-1 px-1.5 py-0.5 bg-muted rounded text-emerald-700 dark:text-emerald-300 text-xs">eth_call</code>. This
